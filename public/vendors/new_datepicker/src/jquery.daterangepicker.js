    ...
    $.fn.dateRangePicker = function(opt) {
        ...
        function createDom() {
            ...
            if (opt.showTopbar) {
                ...
                html += '<div class="container-button-calendar"><button class="btn-calendar btn-calendar-ayer">Ayer</button><button class="btn-calendar btn-calendar-hoy">Hoy</button><button class="btn-calendar btn-calendar-7">Ultimos 7 dias</button><button class="btn-calendar btn-calendar-actual">Mes Actual</button><button class="btn-calendar btn-calendar-pasado">Mes Pasado</button></div>';
            }
