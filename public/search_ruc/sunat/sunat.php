<?php
	...
	class ruc {
		...
		function __construct( $config = array() )
		{
			...
			$this->curl->setReferer( "http://e-consultaruc.sunat.gob.pe/cl-ti-itmrconsruc/FrameCriterioBusquedaWeb.jsp" );
			...
			if( $numRand !== false )
			{
				...
				if( $this->curl->getHttpStatus()==200 && $response!="" )
				{
					...
					{	
						...
						// $_find = "CONSULTA RUC: 10735703795 - ALFONZO HERNANDEZ MIGUEL ALBERTO";

						// $_end=";/font&gt;&lt;/td&gt;<span class='sf-dump-default sf-dump-ns'>\r\n</span>";
						
						// if (strpos($_find, '10735703795')) {
    		// 				dd('true');
