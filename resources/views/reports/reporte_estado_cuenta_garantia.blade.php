<html>
<head>
  <title>Reporte Estado Cuenta Garantia</title>
  <style>
    body{
          ...
          <table style="width: 100%;font-size: 14px;padding-top: 6px;padding-bottom: 6px;font-weight: normal;">
                    <tr>
                        ...
                        <th style="width:70%;text-align: center;">
                            <h4 style="text-decoration: underline;color: blue">Estado de Cuenta con Garantías</h4>
                          ...
                          @foreach($key['sub_detalle'] as $last)
                              ...
                              <tr style="color:green">
                                ...
                                <tr style="color:black">
                                  <td colspan="6">GARANTIAS</td>
                                </tr>

                                <tr style="color:#000">
                                  <td style="background: #9E9998">Fecha &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Emisión</td>
                                  <td style="background: #9E9998">Documento</td>
                                  <td style="background: #9E9998">Monto / Disponible</td>
                                  
                                  <td style="background: #9E9998">Estado</td>
                                  <td></td>
                                  <td></td>
                                </tr>
                                ...
                                <?php
                                  ...
                                  $gar_disponible = $last->GarDisponible;

                                  if(!empty($last->GarDisponible)){

                                      $gar_disponible = number_format($last->GarDisponible, 2, '.', ',');

                                  }

                                ?>
                                <tr style="color:#000">
                                  <td>{{$last->GarFechaCreacion}} &nbsp;&nbsp;{{$last->GarFechaEmision}}</td>
                                  
                                  <td>{{$last->GarDocumento}}</td>
                                  <td>{{$gar_moneda}} {{number_format($last->GarMonto, 2, '.', ',')}} / {{$gar_disponible}}</td>
                                  
                                  <td>{{$last->GarEstado}}</td>
                                  <td></td>
                                  <td></td>
                                </tr>
