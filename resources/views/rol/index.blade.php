              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <span class="badge badge-dark text-white badge-resize-font">Roles</span>&nbsp<small class="badge badge-info font-size-12"><i class="fa fa-lock icon-right"></i>Seguridad</small>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4  padding-5" >
                        <label class="control-label col-xs-3 col-md-3 col-sm-3 margin-top-5">Estado:</label>
                            <div class="col-xs-7 col-md-6 col-sm-6 " >
                                <select class="chosen" id="filtro_roles" name="filtro_roles">
                    ...
                    <div class="col-sm-3 col-md-2 padding-5">
                        ...
                        <button class="btn btn-primary resize-button float-right-button" id="btn_modal_rol"><i class="fa fa-plus icon-right"></i>Nuevo</button>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="card-box table-responsive resize-margin-top">
                          ...
                          <table id="tabla-rol" class="table tbl_out_margin jambo_table letra-size-tablas table-striped" style="width: 100%"> 
...
<div id="modal-rol-create"class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
...
@section('js') 	
<!-- Js de la hoja-->
<script src="{{asset('js/jsApp/rol.js')}}"></script>
