              ...
              <div class="modal-content">
                  ...
                  <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="{{url('/load_file_solicitud_documento')}}" class="dropzone" id="dropzoneSolicitudDoc" enctype="multipart/form-data">
                           @csrf
                           <input type="hidden" id="IdSolicitud_documento" name="IdSolicitud_documento"> 
                           <input type="hidden" id="IdSolicitudDocumento_documento" name="IdSolicitudDocumento_documento">
